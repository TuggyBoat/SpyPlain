class ScoutData:
    def __init__(self, info_dict=None):
        ...
        self.config_setting = info_dict.get('entry_id', None)
        self.config_value = info_dict.get('system_name', None)
        self.config_value = info_dict.get('username', None)
        self.config_value = info_dict.get('user_id', None)
        self.config_value = info_dict.get('timestamp', None)
